...
CREATE TABLE `Users` (
    ...
    `idOTP` CHAR(20) NOT NULL,
    `idProfile_img` CHAR(20) NULL,
    `isActive` BOOLEAN NOT NULL DEFAULT false,
    `isAdmin` BOOLEAN NOT NULL DEFAULT false,
    `cratedAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    UNIQUE INDEX `Users_idOTP_key`(`idOTP`),
    UNIQUE INDEX `Users_idProfile_img_key`(`idProfile_img`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `Travels` (
    `id` VARCHAR(191) NOT NULL,
    `id_user1` CHAR(20) NOT NULL,
    `id_user2` CHAR(20) NULL,
    `id_location` CHAR(20) NOT NULL,
    `id_transportation` CHAR(20) NOT NULL,
    `id_extras` CHAR(20) NULL,
    `isActive` BOOLEAN NOT NULL DEFAULT false,
    ...
    UNIQUE INDEX `Travels_id_user1_key`(`id_user1`),
    UNIQUE INDEX `Travels_id_user2_key`(`id_user2`),
    UNIQUE INDEX `Travels_id_location_key`(`id_location`),
    UNIQUE INDEX `Travels_id_transportation_key`(`id_transportation`),
    UNIQUE INDEX `Travels_id_extras_key`(`id_extras`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `cat_Locations` (
    `id` VARCHAR(191) NOT NULL,
    `id_locationImage` CHAR(20) NOT NULL,
...
CREATE TABLE `User_Comments` (
    ...
    `id_userComented` CHAR(20) NOT NULL,
    `id_userComent` CHAR(20) NOT NULL,
    `cratedAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
